/*
This is a tutorial from gfg to understand how mutex locking work, which ensures that two or more concurrent processes or threads do not execute some particular program segment.
...
To compile : gcc mutex.c -lpthread
*/
